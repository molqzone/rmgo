...
inline constexpr std::array referee_robots_hp_fields{
    RefereeStatusField::robots_hp_red_1,
    RefereeStatusField::robots_hp_red_2,
    RefereeStatusField::robots_hp_red_3,
    RefereeStatusField::robots_hp_red_4,
    RefereeStatusField::robots_hp_red_5,
    RefereeStatusField::robots_hp_red_7,
    RefereeStatusField::robots_hp_red_outpost,
    RefereeStatusField::robots_hp_red_base,
    RefereeStatusField::robots_hp_blue_1,
    RefereeStatusField::robots_hp_blue_2,
    RefereeStatusField::robots_hp_blue_3,
    RefereeStatusField::robots_hp_blue_4,
    RefereeStatusField::robots_hp_blue_5,
    RefereeStatusField::robots_hp_blue_7,
    RefereeStatusField::robots_hp_blue_outpost,
    RefereeStatusField::robots_hp_blue_base,
};

inline constexpr std::array referee_radar_mark_fields{
    RefereeStatusField::radar_mark_hero,
    RefereeStatusField::radar_mark_engineer,
    RefereeStatusField::radar_mark_infantry_3,
    RefereeStatusField::radar_mark_infantry_4,
    RefereeStatusField::radar_mark_infantry_5,
    RefereeStatusField::radar_mark_sentry,
};

inline constexpr std::array referee_ally_robot_position_fields{
    RefereeStatusField::ally_hero_position_x,
    RefereeStatusField::ally_hero_position_y,
    RefereeStatusField::ally_engineer_position_x,
    RefereeStatusField::ally_engineer_position_y,
    RefereeStatusField::ally_infantry_3_position_x,
    RefereeStatusField::ally_infantry_3_position_y,
    RefereeStatusField::ally_infantry_4_position_x,
    RefereeStatusField::ally_infantry_4_position_y,
    RefereeStatusField::ally_infantry_5_position_x,
    RefereeStatusField::ally_infantry_5_position_y,
};
