...
public:
  ...
  controller_interface::CallbackReturn on_activate(const rclcpp_lifecycle::State& /*previous_state*/) override
  {
    ...
    reset_references();
    return write_wheel_commands({ 0.0, 0.0, 0.0, 0.0 }) ? controller_interface::CallbackReturn::SUCCESS :
                                                              ...
                                                              const rclcpp::Duration& /*period*/) override
  {
    std::array<double, 4> wheel_commands =
        inverse_kinematics(reference_interfaces_[0], reference_interfaces_[1], reference_interfaces_[2]);
