...
inline Eigen::Isometry3d make_wheel_transform(double x, double y, double yaw, double angle)
{
  ...
  transform.linear() =
      (Eigen::AngleAxisd{ yaw, Eigen::Vector3d::UnitZ() } * Eigen::AngleAxisd{ angle, Eigen::Vector3d::UnitX() })
          .matrix();
  return transform;
}
...
struct fast_tf::Joint<rmgo_description::ImuLink> : fast_tf::ModificationTrackable
{
  ...
  Eigen::Quaterniond transform{ Eigen::AngleAxisd{ std::numbers::pi / 2.0, Eigen::Vector3d::UnitZ() } };
};
...
struct fast_tf::Joint<rmgo_description::LeftFrontWheelLink> : fast_tf::ModificationTrackable
{
  ...
  void set_state(double angle)
  {
    transform = rmgo_description::detail::make_wheel_transform(rmgo_description::wheel_distance_x / 2.0,
                                                               rmgo_description::wheel_distance_y / 2.0,
                                                               std::numbers::pi / 4.0, angle);
  }

  Eigen::Isometry3d transform = rmgo_description::detail::make_wheel_transform(
      rmgo_description::wheel_distance_x / 2.0, rmgo_description::wheel_distance_y / 2.0, std::numbers::pi / 4.0, 0.0);
};
...
struct fast_tf::Joint<rmgo_description::LeftBackWheelLink> : fast_tf::ModificationTrackable
{
  ...
  void set_state(double angle)
  {
    transform = rmgo_description::detail::make_wheel_transform(-rmgo_description::wheel_distance_x / 2.0,
                                                               rmgo_description::wheel_distance_y / 2.0,
                                                               3.0 * std::numbers::pi / 4.0, angle);
  }

  Eigen::Isometry3d transform =
      rmgo_description::detail::make_wheel_transform(-rmgo_description::wheel_distance_x / 2.0,
                                                     rmgo_description::wheel_distance_y / 2.0,
                                                     3.0 * std::numbers::pi / 4.0, 0.0);
};
...
struct fast_tf::Joint<rmgo_description::RightFrontWheelLink> : fast_tf::ModificationTrackable
{
  ...
  Eigen::Isometry3d transform =
      rmgo_description::detail::make_wheel_transform(rmgo_description::wheel_distance_x / 2.0,
                                                     -rmgo_description::wheel_distance_y / 2.0, -std::numbers::pi / 4.0,
                                                     0.0);
};
...
using Tf = fast_tf::JointCollection<YawLink, PitchLink, ImuLink, MuzzleLink, CameraLink, LeftFrontWheelLink,
